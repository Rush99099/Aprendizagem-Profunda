...
if __name__ == '__main__':
    ...
    net.add(DenseLayer(2, input_shape=(n_features,)), weights=np.array([[20, -20], [20, -20]]), biases=np.array([[-30, 10]]))
    net.add(SigmoidActivation())
    net.add(DenseLayer(1), weights=np.array([[20], [20]]), biases=np.array([[-10]]))
    net.add(SigmoidActivation())
